...
public class GladLib {
    ...
    /* Will load words from preset file name. */
    /*
    private void loadFileByLines(ArrayList<String> currentList, String currentFileName) throws FileNotFoundException {
        Scanner scanLines = new Scanner(new File(path + currentFileName));
        while (scanLines.hasNextLine()) {           //grab line of file, send it to loadWords for splitting and loading
            loadWords(currentList, scanLines.nextLine());
        }
        scanLines.close();
    } */
